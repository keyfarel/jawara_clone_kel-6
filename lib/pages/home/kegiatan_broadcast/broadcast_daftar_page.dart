...
class _BroadcastDaftarPageState extends State<BroadcastDaftarPage> {
  ...
  Widget _buildRow(int no, String pengirim, String judul, String tanggal) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 8),
      child: Row(
        children: [
          Expanded(flex: 1, child: Text(no.toString(), textAlign: TextAlign.center)),
          Expanded(flex: 3, child: Text(pengirim, textAlign: TextAlign.center, overflow: TextOverflow.ellipsis)),
          Expanded(flex: 3, child: Text(judul, textAlign: TextAlign.center, overflow: TextOverflow.ellipsis)),
          Expanded(flex: 3, child: Text(tanggal, textAlign: TextAlign.center)),
          Expanded(
            flex: 3,
            child: Row(
  ...
  Widget _buildTablePage(List<Map<String, String>> pageItems, int pageIndex) {
    return SingleChildScrollView(
      ...
      child: Container(
        width: 700, // 🔹 Atur lebar tabel minimal agar kolom muat semua
          ...
          children: [
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  Expanded(flex: 3, child: Text('TANGGAL', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold))),
                  Expanded(flex: 3, child: Text('AKSI', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold))),
                ],
              ),
            ),
            ...
            for (int i = 0; i < pageItems.length; i++)
              _buildRow(
                ...
                pageItems[i]['judul']!,
                pageItems[i]['tanggal'] ?? '01/01/2024',
              ),
          ],
        ),
      ),
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            // 🔹 Tabel yang bisa discroll horizontal
